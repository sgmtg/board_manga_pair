<x-guest-layout>
    <div class="relative flex flex-col items-center bg-dots-darker bg-center bg-gray-100 dark:bg-dots-lighter dark:bg-gray-900 selection:bg-red-500 selection:text-white">
        ...
        <div class="p-3">
            <a href="{{ route('posts.index', ['category_id'=> 2]) }}" class="text-3xl px-4 font-semibold text-green-300 hover:text-green-500 dark:text-gray-400 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">
                原作を探す
            </a>
            <a href="{{ route('posts.index', ['category_id'=> 1]) }}" class="text-3xl px-4 font-semibold text-blue-300 hover:text-blue-500 dark:text-gray-400 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">
                作画を探す
            </a>
        </div>
        @if (Route::has('login'))
        ...
        <div class="p-3">
            @auth
            <a href="{{ url('/dashboard') }}" class="text-3xl p-3 font-semibold text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">Dashboard</a>
            @else
